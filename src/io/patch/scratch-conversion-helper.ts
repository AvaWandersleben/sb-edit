...
export function processInputs(blocks: any, currentBlockId: any, currentBlock: any, patchApi: any, patchApiKeys: any, convertBlocksPart: any, autoParentheses = false, tryMakeNum = false) {
   const returnVal:any = {};
